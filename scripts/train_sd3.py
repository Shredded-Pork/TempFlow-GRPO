...
class DistributedKRepeatSampler(Sampler):
    def __init__(self, dataset, batch_size, k, num_replicas, rank, seed=0):
        ...
        self.batch_size = batch_size  # batch of each gpu
        ...
        self.m = self.total_samples // self.k  # number of different samples
        self.epoch=0
    ...
    def __iter__(self):
        while True:
            ...
            # disctribute the samples into different gpus
            per_card_samples = []
